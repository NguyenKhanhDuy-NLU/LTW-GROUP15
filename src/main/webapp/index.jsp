...
<header class="header">
    <div class="container">
        <nav class="navbar">
            <div class="logo">
                <a href="${pageContext.request.contextPath}/"><img src="${pageContext.request.contextPath}/images/logo.jpg" alt="logo GROUP15"></a>
            </div>
            <div class="nav-right">
                <div class="language-currency">
                    <img src="${pageContext.request.contextPath}/images/Anh_VN.webp" alt="Việt Nam">
                    <span>VND</span>
...
<section class="hero">
    <div class="hero-background">
        <img src="${pageContext.request.contextPath}/images/Hero%20Header.png" alt="ảnh bìa chính">
    </div>
        ...
        <div class="destination-grid">
            <a href="${pageContext.request.contextPath}/hotel-detail?id=1" class="destination-card-link">
                <div class="destination-card">
                    <img src="${pageContext.request.contextPath}/images/img1.png" alt="Hà Nội">
            ...
            <a href="${pageContext.request.contextPath}/hotel-detail?id=2" class="destination-card-link">
                <div class="destination-card">
                    <img src="${pageContext.request.contextPath}/images/img2.png" alt="Vịnh Hạ Long">
                    <div class="card-content">
                        <h3>Vịnh Hạ Long</h3>
            ...
            <a href="${pageContext.request.contextPath}/hotel-detail?id=3" class="destination-card-link">
                <div class="destination-card">
                    <img src="${pageContext.request.contextPath}/images/img3.png" alt="Nha Trang">
                    <div class="card-content">
                        <h3>Nha Trang</h3>
            ...
            <a href="${pageContext.request.contextPath}/hotel-detail?id=4" class="destination-card-link">
                <div class="destination-card">
                    <img src="${pageContext.request.contextPath}/images/img4.png" alt="Huế">
                    <div class="card-content">
                        <h3>Huế</h3>
        ...
        <div class="sights-grid">
            <a href="${pageContext.request.contextPath}/hotel-detail?id=11" class="sight-card-link span-3">
                <div class="sight-card">
                    <img src="${pageContext.request.contextPath}/images/img5.png" alt="Vịnh Hạ Long">
            ...
            <a href="${pageContext.request.contextPath}/hotel-detail?id=12" class="sight-card-link span-3">
                <div class="sight-card">
                    <img src="${pageContext.request.contextPath}/images/img6.png" alt="Hội An">
                    <div class="sight-content">
                        <h3>Hội An</h3>
                    </div>
                </div>
            ...
            <a href="${pageContext.request.contextPath}/hotel-detail?id=13" class="sight-card-link span-2">
                <div class="sight-card">
                    <img src="${pageContext.request.contextPath}/images/img7.png" alt="Nha Trang">
                    <div class="sight-content">
                        <h3>Nha Trang</h3>
                    </div>
                </div>
            ...
            <a href="${pageContext.request.contextPath}/hotel-detail?id=14" class="sight-card-link span-2">
                <div class="sight-card">
                    <img src="${pageContext.request.contextPath}/images/img8.png" alt="Phú Quốc">
                    <div class="sight-content">
                        <h3>Phú Quốc</h3>
                    </div>
                </div>
            ...
            <a href="${pageContext.request.contextPath}/hotel-detail?id=16" class="sight-card-link span-2">
                <div class="sight-card">
                    <img src="${pageContext.request.contextPath}/images/img9.png" alt="Huế">
                    <div class="sight-content">
                        <h3>Huế</h3>
                    </div>
                </div>
...
<script src="${pageContext.request.contextPath}/js/home_js.js"></script>
</body>
</html>